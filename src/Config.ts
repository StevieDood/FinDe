...
export const WEDDING_DATE = '22 de Diciembre, 2023';
export const WEDDING_LOCATION = 'Xochimilcas 63, Col. Tezozomoc. Azcapotzalco';

export const GROOM_NAME = 'Fiesta de Fin de Año';
...
export const BRIDE_NAME = 'Acción de Gracias';
